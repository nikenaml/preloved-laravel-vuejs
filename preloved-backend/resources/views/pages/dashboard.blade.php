                    ...
                    <div class="stat-widget-five">
                        ...
                        <div class="stat-content">
                            <div class="text-left dib">
                                <div class="stat-text">IDR <span class="count">{{ $income }}</span></div>
...
@push('after-script')
    <!--Local Stuff-->
    <!-- kenapa kodingan grafik pie di taruh di dashboard bukannya di script.blade.php
    karna tampilan pie akan di tampilkan atau dipanggil hanya di halaman dashboard bukan di semua halaman, sedangkan
    script.blade.php akan di panggil di semua halaman -->
    <script>
